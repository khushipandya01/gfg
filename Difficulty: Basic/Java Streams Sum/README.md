<h2><a href="https://www.geeksforgeeks.org/problems/java-streams-sum/1?page=3&category=Java&difficulty=Basic,Easy&sortBy=submissions">Java Streams Sum</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an integer array <strong>arr[]</strong>, find the sum of the array using streams.</span></p>
